        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    thumbNailTitleImg = table.Column<byte[]>(type: "varbinary(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_hoodieImgs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_hoodieImgs_hoodies_hoodieId",
                        column: x => x.hoodieId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_hoodies_HoodieId",
                        column: x => x.HoodieId,
                        principalTable: "hoodies",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ordersDetails_hoodies_hoodieId",
                        column: x => x.hoodieId,
                        principalTable: "hoodies",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ordersDetails_hoodieId",
                table: "ordersDetails",
                column: "hoodieId");
